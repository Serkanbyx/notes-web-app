...
function NoteDetailPage() {
  ...
  const existingNote = id && id !== 'new' ? getNoteById(id) : undefined;
  ...
  const handleSubmit = useCallback((data: NoteSchemaType) => {
    setFormData(data);
    saveNow();
  }, [saveNow]);
          ...
          <div className="flex items-center gap-2 text-sm">
            {saveStatus === 'saving' && (
              <>
                ...
                <span className="text-yellow-600">Kaydediliyor...</span>
              </>
            )}
            ...
            {saveStatus === 'unsaved' && (
              <>
                ...
                <span className="text-gray-500">Kaydedilmemiş değişiklikler</span>
              </>
            )}
          </div>
        </div>
